...
public class SelectRemoteActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        Intent viewRemoteIntent = new Intent(this, RemoteViewActivity.class);
